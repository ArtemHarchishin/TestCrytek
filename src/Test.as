	...
	public class Test extends MovieClip {
		public function Test() {
			...
			var hierarchicalData:Array = [
				{
					label: "Kerkira",
					items: [{label: "Characters", items: [{label: "John"}, {label: "Phil"}]}, {
						label: "Events",
						items: [{label: "Psytrance party"}, {label: "Singing Fountains"}]
					}, {label: "Points of interest", items: [{label: "Drags"}, {label: "Rock'n'Roll"}]}]
				},
				{label: "Kiev", items: []},
				{label: "Lviv", items: []},
				{label: "Odessa", items: []},
			...
			groupedCollection.addGroupItem({
				label: "123new Group Item",
				items: [{label: "new item 1"}, {label: "new item 2"}]
			});
